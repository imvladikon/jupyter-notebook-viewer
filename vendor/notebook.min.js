(function () {
  ...
  var math_delimiters = [{left: "$$", right: "$$", display: true}, {
    left: "\\[",
    right: "\\]",
    display: true
  ...
  nb.Cell.prototype.renderers = {
    markdown: function () {
      ...
      if (root.renderMathInElement != null) {
        ...
        el.innerHTML = nb.sanitizer(nb.markdown(el.innerHTML.replace(/&gt;/g, ">")))
      } else {
        ...
        var markdown = tokenize(joined)
        var html = marked(markdown);
        html = detokenize(html)
        el.innerHTML = nb.sanitizer(html)
      }
      return el
    }, heading: function () {
